...
void solve() {
  ...
  int odd_num_mod_2;
  fo(i, 3) {
    if (num_mod_2[0] == num_mod_2[1])
      odd_num_mod_2 = !num_mod_2[0];
    else if (num_mod_2[0] == num_mod_2[2])
      odd_num_mod_2 = !num_mod_2[0];
    else if (num_mod_2[1] == num_mod_2[2])
      odd_num_mod_2 = !num_mod_2[1];
  }
  fo(i, n) {
    if (num_mod_2[i] == odd_num_mod_2) cout << i + 1 << endl;
  }
}
