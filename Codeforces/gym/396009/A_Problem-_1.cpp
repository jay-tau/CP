...
void solve() {
	/* Half the permutations will be answer. Why? Because if abc is allowed, then cba is not allowed
	acb is not allowed. But bca is allowed. So, half the permutations will be answer. */
	int n;
	cin >> n;
